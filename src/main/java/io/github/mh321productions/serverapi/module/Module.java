...
public abstract class Module {
	 ...
	 */
	public abstract boolean registerSubPlugin(SubPlugin sub, @Nullable ModuleStopFunction func);
	 ...
	 */
	protected boolean addIntern(SubPlugin sub, @Nullable ModuleStopFunction func) {
